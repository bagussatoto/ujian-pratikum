        ...
        <div class="card">
          <div class="card-header">
            <div class="row">
              ...
              <div class="ml-auto">
                <a class="btn btn-primary" href="<?= base_url('sesi/showdata_sesi'); ?>">
          ...
          <div class="card-body">
            <form action="<?= base_url('sesi/store_sesi') ?>" method="POST">
              <div class="form-group">
                <label for="nama_sesi">Sesi</label>
                <input class="form-control" type="text" name="nama_sesi" id="nama_sesi">
