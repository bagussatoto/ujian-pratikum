                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="ml-auto"><a class="btn btn-primary" href="<?= base_url('matkul/showdata_matkul'); ?>">
                    ...
                    <div class="card-body">
                        <form action="" method="POST">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="kode" id="kode" value="<?= $matkul['kode']; ?>">
                                <small class="form-text text-danger"><?= form_error('kode'); ?></small>
                            </div>
                            <div class="form-group">
                                <matkulel for="nama_matkul">Mata Kuliah</matkulel>
                                <input class="form-control" type="text" name="nama_matkul" id="nama_matkul" value="<?= $matkul['nama_matkul']; ?>">
