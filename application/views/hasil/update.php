                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="ml-auto"><a class="btn btn-primary" href="<?= base_url('hasil/showdata_hasil'); ?>">
                    ...
                    <div class="card-body">
                        <form action="" method="POST">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="nama_hasil" id="nama_hasil" value="<?= $hasil['nama_hasil']; ?>">
