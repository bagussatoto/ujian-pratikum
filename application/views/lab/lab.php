            ...
            <div class="card mb-12">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="ml-auto">
                            <a class="btn btn-primary" href="<?= base_url('lab/store_lab'); ?>">
                            ...
                            <tbody>
                                <?php foreach ($lab as $r) : ?>
                                    <tr>
                                        ...
                                        <td class="row">
                                            <div class="mx-auto">
                                                <a href="<?= base_url('lab/update_lab/') . encrypt_url($r['id_lab']); ?>"><i class="far fa-edit"></i></a>
                                                <a href="<?= base_url('lab/hapus_lab/') . encrypt_url($r['id_lab']); ?>"><i class="far fa-trash-alt"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
