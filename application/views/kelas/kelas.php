            ...
            <div class="card mb-12">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="ml-auto">
                            <a class="btn btn-primary" href="<?= base_url('kls/store_kelas'); ?>">
                            ...
                            <tbody>
                                <?php foreach ($kelas as $r) : ?>
                                    <tr>
                                        ...
                                        <td class="row">
                                            <div class="mx-auto">
                                                <a href="<?= base_url('kls/update_kelas/') . encrypt_url($r['id_kls']); ?>"><i class="far fa-edit"></i></a>
                                                <a href="<?= base_url('kls/hapus_kelas/') . encrypt_url($r['id_kls']); ?>"><i class="far fa-trash-alt"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
